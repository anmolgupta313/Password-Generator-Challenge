...
//Creating function generatePassword and creating variables for lowercase, upperccase, specialcharacters and more
function generatePassword() {
  ...
  //creating a variable and created a promt value with conditional statement
  ...
  //Created a variable for lower case and set consitional statement
  ...
  //Created a variable for Upper case and set consitional statement
...
//Created a variable for Number and set consitional statement
  ...
  //Created a variable for special Character and set consitional statement
  ...
  //created a consitional statement and concat with variable accordingly
  if (hasLowercase) {
